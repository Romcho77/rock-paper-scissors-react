...
export default function choice(props) {
  ...
  return (
    <div className='flex flex-col  justify-center items-center h-[160px] w-[160px] bg-white p-5 z-0 rounded-[50%] shadow-inner drop-shadow-2xl shadow-gray-950 transition
